...
const Header = () => {
  return (
    <div className="bg-primary flex rounded-lg flex-col md:flex-row flex-wrap px-6 md:px-10 lg:px-20">
      {/* left section */}
      <div className="md:w-1/2 flex flex-col items-start justify-center gap-4 py-10 m-auto md:py-[10vw] md:md-[-30px]">
        <div>
          <h1 className="text-3xl md:text-4xl lg:text-5xl  font-semibold text-white leading-tight md:leading-tight lg:leading-tight">
        ...
        <div className="flex flex-col md:flex-row items-center gap-3 text-white text-sm font-light">
          ...
          <p>
            Simply browse through our extensixe list of trusted doctors, <br />{" "}
